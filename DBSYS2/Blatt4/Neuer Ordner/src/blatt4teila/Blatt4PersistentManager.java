...
public class Blatt4PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Blatt4";
	...
	private Blatt4PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Blatt4PersistentManager();
		}
